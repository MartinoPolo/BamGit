...
export const MOCK_DASHBOARDS: Dashboard[] = [
	...
	{
		id: 'dashboard-low-poly-trees',
		name: 'Low Poly 2D Trees',
		type: 'repo',
		github_repo: 'MartinoPolo/low-poly-2d-trees',
		local_folder: 'C:/_MP_projects/low-poly-2d-trees',
	...
	},
	{
		...
		name: 'Design System',
		type: 'repo',
		github_repo: 'MartinoPolo/design-system',
		local_folder: 'C:/_MP_projects/design-system',
		default_base_branch: 'main',
		worktree_parent_folder: null,
		color_palette_id: PALETTE_VIVID,
		accent_color: '#a855f7',
...
export const MOCK_PROCESSES: RunningProcess[] = [
	{
		process_id: 'mock-proc-dev-server',
		command_id: 'mock-cmd-dev-server',
		issue_id: ISSUE_AUTH_MIDDLEWARE,
		category: 'server',
		name: 'Dev Server',
		pid: 12340,
