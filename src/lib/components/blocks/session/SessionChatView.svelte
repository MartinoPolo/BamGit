<script lang="ts">
	...
	import {
		...
		QuickNavButtons,
		AssistantMessage,
	} from '$lib/components/blocks/chat/index.js';
	import SessionTopBar from '$lib/components/blocks/session/SessionTopBar.svelte';
	import SessionSidebar from '$lib/components/blocks/session/SessionSidebar.svelte';
	import FloatingInputPanel from '$lib/components/blocks/session/FloatingInputPanel.svelte';
