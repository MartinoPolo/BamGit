...
const COMMAND_BODIES: Record<string, string> = {
	...
	focus_window: 'Focusing windows requires the desktop app',
	open_workspace_window: 'Opening new windows requires the desktop app',
	list_open_windows: 'Listing windows requires the desktop app',
	...
	delete_hook_from_settings: 'Deleting hooks requires the desktop app',
	delete_mcp_from_settings: 'Deleting MCP servers requires the desktop app',
	set_skill_override: 'Setting skill overrides requires the desktop app',
	write_provider_settings: 'Writing provider settings requires the desktop app',
